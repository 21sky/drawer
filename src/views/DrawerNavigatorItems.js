...
export default class DrawerNavigatorItems extends React.Component {
    ...
    render() {
        const { items, activeItemKey, getLabel, renderIcon, onItemPress, itemsContainerStyle, itemStyle, labelStyle, activeLabelStyle, inactiveLabelStyle, iconContainerStyle, drawerPosition, } = this.props;
        ...
        return (React.createElement(View, { style: [styles.container, itemsContainerStyle] }, items.map((route, index) => {
            ...
            const extraLabelStyle = focused
                ? activeLabelStyle
                : inactiveLabelStyle;
            return (React.createElement(TouchableItem, { key: route.key, accessible: true, accessibilityLabel: accessibilityLabel, onPress: () => {
                    onItemPress({ route, focused });
                }, delayPressIn: 0 },
                React.createElement(SafeAreaView, { style: [{ backgroundColor }, styles.item, itemStyle], forceInset: {
                        [drawerPosition]: 'always',
                        [drawerPosition === 'left' ? 'right' : 'left']: 'never',
                        vertical: 'never',
                    } },
                    icon ? (React.createElement(View, { style: [
                            styles.icon,
                            focused ? null : styles.inactiveIcon,
                            iconContainerStyle,
                        ] }, icon)) : null,
                    typeof label === 'string' ? (React.createElement(Text, { style: [
                            styles.label,
                            { color },
                            labelStyle,
                            extraLabelStyle,
